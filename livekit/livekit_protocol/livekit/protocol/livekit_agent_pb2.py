...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _JOB.fields_by_name['namespace']._options = None
  _JOB.fields_by_name['namespace']._serialized_options = b'\030\001'
  _AVAILABILITYRESPONSE_PARTICIPANTATTRIBUTESENTRY._options = None
  _AVAILABILITYRESPONSE_PARTICIPANTATTRIBUTESENTRY._serialized_options = b'8\001'
